...
const menus = (state = initialState, action) => {
  switch (action.type) {
    ...
    case 'UPDATE_DESSERT':
      let dataDessert = action.dessert.findIndex(
    ...
    case 'FALSE_MENU':
      let dataOrdersFix = action.menu.findIndex(
        y => y.id == action.payload.menuId,
      );
    ...
    case 'FALSE_DRINK':
      let dataDrinkFix = action.menu.findIndex(
        y => y.id == action.payload.menuId,
      );
    ...
    case 'FALSE_DESSERT':
      let dataDessertFix = action.menu.findIndex(
        y => y.id == action.payload.menuId,
      );
